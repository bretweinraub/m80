...
sub generate {
	...
	SWITCH : {
		...
		$rc += system ("make -f /usr/local/m80-0.07/share/m80/lib/make/m80standalone.mk --no-print-directory $iter");
		last SWITCH;
	    };
...
This document describes 0.07.33 of m80::m80path
