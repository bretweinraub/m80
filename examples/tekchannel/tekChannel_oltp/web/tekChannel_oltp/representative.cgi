...
$formElems[0]->{name} = "emailaddress";
$formElems[0]->{type} = "varchar";
$formElems[0]->{length} = "64";
$formElems[0]->{realName} = $formElems[0]->{name};
$formElems[0]->{root} = "emailaddress";
...
$formElems[3]->{name} = "firstname";
$formElems[3]->{type} = "varchar";
$formElems[3]->{length} = "32";
$formElems[3]->{realName} = $formElems[3]->{name};
$formElems[3]->{root} = "firstname";
